...
export const RULE_DEFS: RuleDef[] = [
  ...
  { key: 'DT3', label: '预算烧尽过早', layer: 'D', layerFull: '日层', color: '#1a73e8',
    auto: true,  icon: '💰',
  ...
  { key: 'DT5', label: '新品冷启动豁免', layer: 'D', layerFull: '日层', color: '#1557b0',
    auto: true,  icon: '🌱',
  ...
  { key: 'WK1', label: '全店周毛利复盘', layer: 'W', layerFull: '周层', color: '#1a73e8',
    auto: false, icon: '📈',
  ...
  { key: 'WK5', label: '生命周期+预算分配', layer: 'W', layerFull: '周层', color: '#1557b0',
    auto: true,  icon: '🗂️',
